...
# Threat Hunting Guidance for Unsigned vSphere Installation Bundles (VIBs) in ESXi (89619)
...
``` powershell 
#Please read the instructions on KB https://kb.vmware.com/s/article/89619

# Version 1.2 (29-09-2022 11:00)

#Read the vCenter Server FQDN or IP Address
$vcenter = Read-Host "`nPlease Enter the IP Address or FQDN of vCenter Server"
...
#Read VC Credentials
$VCCred = Get-Credential -UserName $UserName -Message "Please enter the SSO Administrator Credentials"

#Connect to vCenter Server and terminate if login fails
try
{
